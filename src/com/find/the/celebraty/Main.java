package com.find.the.celebraty;
...
public class Main {
    public static void main(String[] args) {
        Solution.cel = 4;
        System.out.println(Solution.findCelebrity(5));
    }
}
...
class Solution {
    ...
    public static int findCelebrity(int n) {
        int can = 0;
        for(int i = 0; i < n; i++) if (knows(can, i)) can = i;
        for(int i = 0; i < n; i++) if (i != can && knows(can, i) || !knows(i, can)) return -1;
        return can;
    }
}
