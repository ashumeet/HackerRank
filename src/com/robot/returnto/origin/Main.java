package com.robot.returnto.origin;
...
public class Main {
    public static void main(String[] args) {
        System.out.println(Solution.robotReturn("UD"));
        System.out.println(Solution.robotReturn("LL"));
        System.out.println(Solution.robotReturn("UUULLLDDLLUUDRRDRDRR"));
    }
}

class Solution {
    public static boolean robotReturn(String moves) {
        int x = 0, y = 0;
